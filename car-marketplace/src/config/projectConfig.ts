...
/**
 * مكتبة التكوين الرئيسية لمنصة BG Cars Platform
 * تحتوي على جميع الإعدادات والثوابت اللازمة للمشروع
 */
...
export const PROJECT_CONFIG = {
  ...
  // إعدادات Firebase
  FIREBASE: {
    PROJECT_ID: 'bg-cars-platform',
    PROJECT_NUMBER: '407228642196',
    API_KEY: 'AIzaSyAUqK5WGZSIYehZUmu1E0qFNllUOqsF8dE',
    AUTH_DOMAIN: 'bg-cars-platform.firebaseapp.com',
    STORAGE_BUCKET: 'bg-cars-platform.appspot.com',
    MESSAGING_SENDER_ID: '407228642196',
    COLLECTIONS: {
      USERS: 'users',
      SELLERS: 'sellers',
      LISTINGS: 'listings',
  ...
  SEARCH: {
    ELASTICSEARCH: {
      ENDPOINT: process.env.VITE_ELASTICSEARCH_ENDPOINT || 'https://search-bgcars.eu-west-1.es.amazonaws.com',
  ...
  GEOGRAPHY: {
    ...
    MAJOR_CITIES: [
      ...
      { name: 'Стара Загора', nameEn: 'Stara Zagora', lat: 42.4154, lng: 25.6341, population: 138272 },
      { name: 'Плевен', nameEn: 'Pleven', lat: 43.4092, lng: 24.618, population: 106954 },
      { name: 'Сливен', nameEn: 'Sliven', lat: 42.6824, lng: 26.315, population: 89848 },
      { name: 'Добрич', nameEn: 'Dobrich', lat: 43.5775, lng: 27.8258, population: 87370 },
      { name: 'Шумен', nameEn: 'Shumen', lat: 43.2706, lng: 26.9247, population: 80855 }
    ],
    REGIONS: [
  ...
  ANALYTICS: {
    GOOGLE_ANALYTICS: {
      TRACKING_ID: process.env.VITE_GA_TRACKING_ID,
  ...
  EXTERNAL_APIS: {
    ...
    TRANSLATION: {
      ...
      API_KEY: process.env.VITE_GOOGLE_TRANSLATE_API_KEY,
...
export const getFirebaseConfig = () => ({
  apiKey: PROJECT_CONFIG.FIREBASE.API_KEY,
  authDomain: PROJECT_CONFIG.FIREBASE.AUTH_DOMAIN,
  projectId: PROJECT_CONFIG.FIREBASE.PROJECT_ID,
  storageBucket: PROJECT_CONFIG.FIREBASE.STORAGE_BUCKET,
  messagingSenderId: PROJECT_CONFIG.FIREBASE.MESSAGING_SENDER_ID
})
